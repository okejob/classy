        ...
        $.ajax({
            ...
            for (let i = 0; i < trans.item_transaksi.length; i++) {
                ...
                let temp = "<tr id='" + item.id + "'>" +
                    ...
                    "<td class='d-none d-lg-table-cell'>" + item.nama_kategori + "</td>";
