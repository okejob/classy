...
<div class="container">
    ...
    <section id="pengaturan-outlet" class="mb-5 d-none">
        <div class="card">
            <div class="card-body">
                ...
                <form>
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <h5>Kode Outlet</h5><input type="text" class="form-control" name="kode_outlet" />
                        </div>
                        <div class="col-12 col-sm-6">
                            <h5>Nama Outlet</h5><input type="text" class="form-control" name="nama_outlet" />
                        </div>
                        <div class="col-12">
                            <h5>Alamat lengkap</h5><input type="text" class="form-control" name="alamat" />
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <h5>Telepon 1</h5><input type="text" class="form-control" name="telepon_1" />
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <h5>Telepon 2</h5><input type="text" class="form-control" name="telepon_2" />
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <h5>Nomor Fax</h5><input type="text" class="form-control" name="nomor_fax" />
                        </div>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <h5>Status</h5>
                            <div class="form-control d-flex justify-content-around" style="height: 38px;">
                                <div class="form-check"><input type="radio" class="form-check-input" id="radio-status-aktif" /><label class="form-check-label" for="radio-status-aktif">Aktif</label></div>
                                <div class="form-check"><input type="radio" class="form-check-input" id="radio-status-nonaktif" /><label class="form-check-label" for="radio-status-nonaktif">Non-aktif</label></div>
                            </div>
                        </div>
    ...
    <!-- if login as master -->
    <section id="pengaturan-outlet-master">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Pengaturan Data Outlet</h4>
                <hr />
