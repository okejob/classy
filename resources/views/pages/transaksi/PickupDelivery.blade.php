...
<div class="container">
    ...
    <ul role="tablist" class="nav nav-tabs border-bottom-0">
        <li role="presentation" class="nav-item"><a role="tab" data-bs-toggle="tab" class="nav-link" href="#tab-1">Data</a></li>
        <li role="presentation" class="nav-item"><a role="tab" data-bs-toggle="tab" class="nav-link active" href="#tab-2">Task Hub</a></li>
    </ul>
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane active" id="tab-2">
            <div class="p-3 border rounded mb-3" style="margin: 0 .375rem 1rem!important;">
                <input type="date" name="input-date" class="form-control">
            </div>
            @foreach ($dataDriver as $driver)
            <div class="card-1 w-50 float-start" style="padding: 0 .375rem!important;">
