                    ...
                    <div class="card-body">
                        <header>
                            <div class="d-flex justify-content-between align-items-center">
                                <h3>ID Transaksi : <span id="id-trans">{{ $data['transaksi_id'] }}</span></h3>
                            ...
                            <table class="table table-striped mb-0" id="table-trans-item">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center" style="padding-top: 4px;padding-bottom: 4px;"><button class="btn btn-primary btn-sm btn-show-action" type="button"><i class="fas fa-bars"></i></button></td>
                                        <td>5</td>
                                    </tr>
                                    <tr>
                                        <td>Item 2</td>
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="7" style="padding-top: 4px;padding-bottom: 4px;"><button class="btn btn-primary btn-sm" type="button"><i class="fas fa-plus"></i></button></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td class="text-end" colspan="6">Sub Total<br>Diskon<br>Grand Total</td>
                                        <td>60000<br>5000<br>55000</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <ul class="list-unstyled form-control" id="list-action">
                            ...
                            <li id="action-mark-spot">Tandai noda</li>
                            <li id="action-photo">Foto item</li>
                        </ul>
                        <div class="row">
                            <div class="col-4 p-2">
                                <h4>Parfum</h4><select class="form-select-sm form-control" style="max-width: 200px;">
                            ...
                            <div class="col-4 p-2">
                                <div class="d-flex justify-content-center align-items-center h-100">
                                    <div class="form-check me-1"><input class="form-check-input" type="checkbox" id="formCheck-express"><label class="form-check-label" for="formCheck-express">Express</label></div>
                                    <div class="form-check ms-1"><input class="form-check-input" type="checkbox" id="formCheck-setrika"><label class="form-check-label" for="formCheck-setrika">Setrika only</label></div>
                                </div>
                            </div>
                            <div class="col-4 p-2">
                            ...
                            <div class="col-8 p-2 d-flex align-items-center">
                                <div class="position-relative w-100"><button class="btn btn-primary" id="show-catatan-trans" type="button" style="width: 200px;">Catatan Transaksi</button>
                                    <div class="position-absolute mt-1 w-100 card p-2" style="z-index: 1;display: none;"><textarea class="form-control"></textarea><button class="btn btn-primary" id="save-catatan-trans" type="button">Simpan Catatan</button></div>
                                </div>
                            </div>
                            <div class="col-4 p-2 d-flex align-items-center">
                                <div class="position-relative text-end w-100"><button class="btn btn-primary" type="button" style="width: 200px;">Kode Promosi</button></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <section id="section-info-pelanggan">
                            <header class="d-flex justify-content-between align-items-center">
                                <h4>Pelanggan</h4><button class="btn show-data" id="show-data-pelanggan" type="button"><i class="fas fa-chevron-down large"></i></button>
                            </header>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-hover" id="table-list-pelanggan">
                                                        <thead class="text-center">
                                                            <tr>
                                                                <th>Nama</th>
                                                                <th><strong>Tanggal Lahir</strong><br></th>
                                                                <th>Alamat</th>
                                                                <th>Membership</th>
                                                            </tr>
                                                        </thead>
                                ...
                                <form id="data-pelanggan" style="/*display: none;*/">
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            <h5>Nama</h5><input class="form-control" type="text" id="input-nama-pelanggan-1" name="username" readonly="">
                                        </div>
                                        <div class="col-12 mb-2">
                                            <h5>Alamat</h5><input class="form-control" type="text" id="input-alamat" readonly="">
                                        </div>
                                        <div class="col-12 mb-2">
                                            <h5>Telepon</h5><input class="form-control" type="text" id="input-telepon1" readonly="">
                                        </div>
                                        <div class="col-12 mb-2">
                                            <h5>E-mail</h5><input class="form-control" type="text" id="input-email" readonly="">
                                        </div>
                                        <div class="col-12 mb-2">
                                            <h5>Tanggal Lahir</h5><input class="form-control" id="input-tanggal-lahir" type="date" readonly="">
                                        </div>
                                        <div class="col-12">
                                            <h5>Catatan Pelanggan</h5><textarea class="form-control" style="resize: none;"></textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <section id="section-info-outlet">
                            <header>
                                <h4 class="d-flex justify-content-between align-items-center">Outlet<button class="btn show-data" id="show-data-outlet" type="button"><i class="fas fa-chevron-down large"></i></button></h4>
                            </header>
                        ...
                        <section id="section-info-pickup-delivery">
                            <header class="d-flex justify-content-between align-items-center">
                                <h4 class="d-flex justify-content-between align-items-center">Pickup &amp; Delivery</h4><button class="btn show-data" id="show-data-pickup-delivery" type="button"><i class="fas fa-chevron-down large"></i></button>
                            </header>
